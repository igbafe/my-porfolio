...
export const projects = [
    {
        ...
        des: "Yoom is a fast, secure, and reliable video calling platform that enables users to host virtual meetings, webinars, and one-on-one calls with ease. ",
        img: "/d1.png",
        iconLists: ["/next.svg", "/tail.svg", "/ts.svg", "/s.svg",],
        link: "https://video-call-app-igbafes-projects.vercel.app/",
    },
    {
        id: 2,
        title: "FoodDel",
        des: "Our food delivery platform lets customers seamlessly browse menus from a variety of local restaurants, place customized orders, and securely pay online — all in one place.",
        img: "/food-del.png",
        iconLists: ["/tail.svg", "/ts.svg", "/next.svg"],
        link: "https://food-del-frontend-2dwv.onrender.com/",
    },
    {
        id: 3,
        title: "LogiSync App",
        des: "A logistics site is a platform that manages the coordination, tracking, and delivery of goods and shipments from origin to destination efficiently.",
        img: "/d2.png",
        iconLists: ["/next.svg", "/tail.svg", "/ts.svg"],
        link: "https://logistics-59dw.onrender.com/",
    },
    {
        id: 4,
        title: "StudyBoosta",
